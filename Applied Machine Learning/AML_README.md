...
| fraud_likelihood_category  |  <ul><li>Checks if an item category belongs to high, medium or low risk.</li><li> Categories with >20% fraud transactions are high risk.</li></ul> <ul><li> Categories with 5-20% fraud transactions are medium risk</li>|
